...
def get_params():
    params = {
        'weight': '/root/ultralytics-8.3.27/runs/train/exp/weights/best.pt',   # 训练出来的权重文件
        'cfg': '/root/ultralytics-8.3.27/ultralytics/cfg/models/v8/yolov8s_yzj.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/root/autodl-tmp/bizhang0223/val/images/captured_image_1736666089.jpg', 'result')  # 第一个是检测的文件, 第二个是保存的路径