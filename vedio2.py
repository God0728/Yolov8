...
parser.add_argument('-v', type=str, default='/root/autodl-tmp/eval0303/2.avi')  # 指定输入视频路径位置（参数必选）
parser.add_argument('-o', type=str, default='/root/ultralytics-8.3.27/')  # 指定输出视频路径位置（参数必选）
